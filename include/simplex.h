...
#define sys_poll(msg) syscall(SYS_POLL, (unsigned long)(msg))
#define sys_wait(msg) syscall(SYS_WAIT, (unsigned long)(msg))
#define sys_peek(msg) syscall(SYS_PEEK, (unsigned long)(msg))
